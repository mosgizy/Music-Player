	...
	return (
		<section className="pt-20 px-5">
			...
			<div className="mt-6 flex flex-col flex-wrap gap-6 md:flex-row md:items-start">
				...
				<div
					className="group bg-no-repeat bg-cover flex flex-row justify-between items-end rounded-[20px] w-full h-[234px] p-5 md:flex-[1_0_24%] lg:flex-[1_0_18.6%]"
					style={{
						backgroundImage: `linear-gradient(179.89deg, rgba(0, 0, 0, 0) 0.1%, rgba(15, 18, 19, 0.85) 80.67%),url(${cover.src})`,
					}}
				>
					<div className="flex flex-col gap-6 text-light">
						<div className="flex flex-col gap-0">
							<h1 className="text-[24px] font-normal">Limits</h1>
							<p className="text-[10px] opacity-40">John watts</p>
						</div>
					...
					<div className="flex justify-center items-center cursor-pointer bg-[rgba(250,205,102,0.4)] w-[34px] h-[34px] rounded-full">
						<FontAwesomeIcon className="text-secondary" icon={faPlay} />
					</div>
				</div>
				<div
					className="bg-no-repeat bg-cover flex flex-row justify-between items-end rounded-[20px] w-full h-[234px] p-5 md:flex-[1_0_24%] lg:flex-[1_0_18.6%]"
					style={{
						backgroundImage: `linear-gradient(179.89deg, rgba(0, 0, 0, 0) 0.1%, rgba(15, 18, 19, 0.85) 80.67%),url(${cover.src})`,
					}}
				>
